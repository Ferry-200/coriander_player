...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__installed_font__get_installed_fonts_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        2 => wire__crate__api__logger__init_rust_logger_impl(port, ptr, rust_vec_len, data_len),
        3 => wire__crate__api__smtc_flutter__SmtcFlutter_close_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        5 => wire__crate__api__smtc_flutter__SmtcFlutter_subscribe_to_control_events_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        6 => wire__crate__api__smtc_flutter__SmtcFlutter_update_display_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        7 => wire__crate__api__smtc_flutter__SmtcFlutter_update_state_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        8 => wire__crate__api__smtc_flutter__SmtcFlutter_update_time_properties_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        10 => wire__crate__api__tag_reader__build_index_from_folders_recursively_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        13 => wire__crate__api__tag_reader__update_index_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        4 => wire__crate__api__smtc_flutter__SmtcFlutter_new_impl(ptr, rust_vec_len, data_len),
        9 => wire__crate__api__system_theme__system_theme_get_system_theme_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
